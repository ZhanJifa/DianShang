...
var Pagination = /** @class */ (function () {
    ...
    Pagination.prototype.render = function () {
        ...
        if (this.options.jumper) {
            ...
            //var DepSizeCoun = this.createElement('select', 'selectDepMenu')
            //DepSizeCoun.innerHTML = "<select id='selPage' style='width: 50px; height: 30px'><option value='2'>2</option >" +
            //    "<option value='5'>5</option><option value='10'>10</option><option value='20'>20</option></select >";
            //jumper.appendChild(DepSizeCoun);
